...
export function RecipeDetailPage() {
  ...
  const handleStudioGenerate = async (prompt: string) => {
    await generateRecipeImage({ recipeId: recipe._id, prompt });
  };
  ...
  const handleStudioAccept = async (imageEntryId: Id<"recipeImages">) => {
        ...
        {recipe.imageUrl ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            >
              ...
              {recipe.imageGenerationStatus === "failed" ? "Try Again" : "Add Image"}
            </button>
          </div>
        )}
